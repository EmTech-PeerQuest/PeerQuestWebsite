              ...
              <div className="p-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {[
                    ...
                    { name: "John Odysseus Lim", role: "Full-Stack/Documentation", avatar: "Odypic.jpg", portfolio: "https://odysseus-droid.github.io/limportfolio", linkedin: "https://www.linkedin.com/in/jhndyssslm/", isPhoto: true },
                  ].map((member, index) => (
