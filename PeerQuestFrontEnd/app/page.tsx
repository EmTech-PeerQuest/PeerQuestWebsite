          ...
          <div className="max-w-5xl mx-auto px-6 py-16">
            ...
            <div className="card mb-10">
              <div className="p-12">
                ...
                <p className="mb-5 leading-relaxed">
                  In the world of PeerQuest, you're not just a developer - you're an adventurer, taking on quests, earning experience, and joining guilds of like-minded peers. Whether you're a novice apprentice or a seasoned archmage of code, there's a place for you at our tavern.
                </p>
                <p className="leading-relaxed">
                  What started as casual meetups to review each other's code soon evolved into a structured system of "quests" and "rewards" - and the fantasy theme made the process more engaging and fun.
                </p>
              </div>
            </div>
            <div className="card">
              <div className="p-12">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {[
                    ...
                    { name: "Amry Judith Gutlay", role: "Full-Stack", avatar: "Amrypic.jpg", portfolio: "https://gutlay-portfolio.vercel.app/", linkedin: "https://www.linkedin.com/in/amry-judith-gutlay-9829962b3/" },
                    { name: "Michael Liam San Diego", role: "Full-stack/UI/UX", avatar: "Liampic.jpg", portfolio: "https://sandiego-portfolio.vercel.app", linkedin: "https://www.linkedin.com/in/michael-liam-san-diego-5a18b7287/" },
                    ...
                    <div key={index} className="text-center bg-white border border-[#CDAA7D] rounded-lg p-8">
                      ...
                      <div className="flex justify-center gap-3">
                        <a href={member.portfolio} target="_blank" rel="noopener noreferrer" className="bg-[#CDAA7D] text-[#2C1A1D] px-3 py-1 rounded text-sm font-medium hover:bg-[#B8941F] transition-colors">Portfolio</a>
                        <a href={member.linkedin} target="_blank" rel="noopener noreferrer" className="bg-[#8B75AA] text-white px-3 py-1 rounded text-sm font-medium hover:bg-[#7A6699] transition-colors">LinkedIn</a>
                      </div>
                    </div>
                  ))}
                </div>
