                        ...
                        <tr key={quest.id} className="hover:bg-gray-50">
                          ...
                          <td className="py-2 px-4 border-b">
                            <div className="flex space-x-2">
                              ...
                              <button
                                onClick={() => setShowDeleteQuestConfirm(quest.id)}
                                className="text-red-600 hover:text-red-800 text-sm"
                              >
                                Delete
                              </button>
                        ...
                        <tr key={guild.id} className="hover:bg-gray-50">
                          ...
                          <td className="py-2 px-4 border-b">
                            <div className="flex space-x-2">
                              ...
                              <button
                                onClick={() => setShowDeleteGuildConfirm(guild.id)}
                                className="text-red-600 hover:text-red-800 text-sm"
                              >
                                Delete
                              </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-medium text-[#2C1A1D]">{selectedQuestDetails.poster.name}</p>
                  </div>
                </div>
                ...
                {selectedQuestDetails.requirements && (
                  <div className="mt-4">
                    ...
                    <ul className="text-[#2C1A1D] text-sm mt-1 list-disc list-inside">
                      {selectedQuestDetails.requirements.map((req, index) => (
                        <li key={index}>{req}</li>
                      ))}
                    </ul>
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h4 className="text-lg font-bold text-[#2C1A1D]">{selectedGuildDetails.name}</h4>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="font-medium text-[#2C1A1D]">{selectedGuildDetails.poster.name}</p>
                  </div>
                </div>
                ...
                {selectedGuildDetails.requirements && (
                  <div className="mt-4">
                    <label className="text-sm font-medium text-gray-600">Requirements</label>
                    <ul className="text-[#2C1A1D] text-sm mt-1 list-disc list-inside">
                      {selectedGuildDetails.requirements.map((req, index) => (
                        <li key={index}>{req}</li>
                      ))}
                    </ul>
                  </div>
