...
def test_gold_addition():
    ...
    try:
        ...
        transaction = Transaction.objects.filter(
            user=test_user,
            type='PURCHASE',
            amount=payment_proof.total_gold_with_bonus
