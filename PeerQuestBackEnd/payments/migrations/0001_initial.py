# Generated by Django 5.2.3 on 2025-07-06 02:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pending', 'Pending Verification'), ('queued', 'Queued for Batch Processing'), ('processing', 'Being Processed'), ('verified', 'Verified'), ('rejected', 'Rejected'), ('completed', 'Completed')], default='queued', max_length=20)),
                ('batch_id', models.CharField(blank=True, max_length=50, null=True)),
                ('scheduled_batch', models.CharField(blank=True, choices=[('morning', '9:00 AM Batch'), ('afternoon', '2:00 PM Batch'), ('evening', '7:00 PM Batch'), ('late_night', '11:00 PM Batch')], max_length=20, null=True)),
